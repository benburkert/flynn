...
INSERT INTO %s (parent_ref, service, domain, tls_cert, tls_key, sticky)
	VALUES ($1, $2, $3, $4, $5, $6)
	RETURNING id, created_at, updated_at`

const sqlAddRouteTCP = `
INSERT INTO %s (parent_ref, service, port)
	VALUES ($1, $2, $3)
	RETURNING id, created_at, updated_at`
...
UPDATE %s SET parent_ref = $1, service = $2, tls_cert = $3, tls_key = $4, sticky = $5
	WHERE id = $6 AND domain = $7 AND deleted_at IS NULL
	RETURNING %s`

const sqlUpdateRouteTCP = `
UPDATE %s SET parent_ref = $1, service = $2
