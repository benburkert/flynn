...
func (s *S) TestBuffer(c *C) {
	...
	msg0 := &rfc5424.Message{Message: []byte{'0'}}
	msg1 := &rfc5424.Message{Message: []byte{'1'}}
	b.Add(msg0)
	b.Add(msg1)
	...
	for i := 2; i < DefaultBufferCapacity+1; i++ {
		b.Add(&rfc5424.Message{Message: []byte(strconv.Itoa(i))})
	}
	res = b.ReadAll()
	...
	res[0] = &rfc5424.Message{Message: []byte("A replacement message")}
